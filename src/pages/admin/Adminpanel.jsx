...
//           </div>
//           <span className="text-xl font-black bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent italic">Btespark Admin</span>
//         </div>
...
//                  <button 
//                   onClick={() => setShowProductModal(true)}
//                   className="bg-slate-900 text-white px-2 py-3.5 rounded-2xl flex items-center gap-3 hover:bg-slate-800 transition-all shadow-xl shadow-slate-200 font-bold text-sm tracking-tight"
//                 >
//                   <PackagePlus size={18} /> ADD CSV FILE
//                 </button>
//               </div>
